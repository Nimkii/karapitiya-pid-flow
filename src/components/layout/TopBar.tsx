...
import { Search, QrCode, Scan, Bell, User, Settings } from 'lucide-react';
        ...
        <div className="flex items-center space-x-2">
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem className="p-3">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Urgent: Bed W05-12 needs attention</p>
                  <p className="text-xs text-muted-foreground">Patient KTH-2508-00045-2 • 5 min ago</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem className="p-3">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">Lab results ready</p>
                  <p className="text-xs text-muted-foreground">FBC report for PID KTH-2508-00032-8 • 15 min ago</p>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem className="p-3">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">New admission pending</p>
                  <p className="text-xs text-muted-foreground">Ward W03 • 1 hour ago</p>
                </div>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>Dr. Kumari Perera</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem>
